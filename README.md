...
This repository contains the low-level binding for OpenGL used in Evergine for .NET 10.0. This binding is generated from gl.xml file included in the KhronosRegistry folder.
